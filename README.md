...
[talhelper](https://github.com/budimanjojo/talhelper), a great tool by [budimanjojo](https://github.com/budimanjojo/) simplifies creation of the necessary configuration. Assuming secrets have already been created run:
...
Apply the configuration to each prepared node (i.e. booted with the talos usb flash drive):
